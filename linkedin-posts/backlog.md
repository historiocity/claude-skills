# LinkedIn post backlog

Parked ideas that could plausibly clear the skill's non-negotiable bar — genuinely new, non-obvious, defensible.
This is a queue of real posts, not a junk drawer of tangents. When a post ships, move it to a dated file in this
folder and delete its entry here.

**Entry format:** handle · claim (one sharp sentence) · why it's non-obvious / the angle · audience · evidence &
links · status (raw / debated / ready-to-build) · source (date + a couple of distinctive terms to re-find the
originating conversation).

To add an idea, Justin can say "remember this for a post" or paste a link to save; append it here as a new entry.
...
- **Why non-obvious:** Goes past the saturated "don't cut juniors" take to the specific self-cannibalizing
  contradiction, plus the "perpetual junior" mechanism (foundational skills never form).
- **Audience:** CHRO, CTO, CEO.
- **Evidence:** Fortune (two-thirds cut, ~62% AI talent from the same cohorts)
  (https://fortune.com/2026/06/07/banks-mass-workforce-cuts-ai-entry-level-jobs-junior-analysts/); Anthropic 17%
  comprehension drop when learning with AI; "perpetual junior" discourse.
- **Status:** debated.
...
- **Why watch it:** The productivity-skepticism space is more crowded (Goldman, MIT NANDA, METR are widely cited),
  so this needs a sharper, FS-specific edge to clear the bar. Hold unless a distinctive angle appears.
- **Audience:** CEO/CFO, investors.
- **Evidence:** Q1 six-big-banks ~15,000 cut vs. $47B profit; Goldman productivity finding.
- **Status:** raw / lower priority.
- **Source:** 2026-07-18 session — terms "profit paradox", "productivity".
